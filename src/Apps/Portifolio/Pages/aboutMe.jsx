        ...
        <div className="Body">
            ...
            <div className="about_sections">
                <div className="about_section1">
                    ...
                    <p className="subtitle_about about_texts">Sou um desenvolvedor FullStack(back-end e front-end). Sou formado em desenvolvimento Web,iOS e crio alguns bots no Discord. Também uma produtora que promove redes sociais criando comerciais/anúncios e deixando mais profissional, deixando-as pronta para o mercado</p>
